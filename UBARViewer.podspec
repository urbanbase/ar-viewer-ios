#
#  Be sure to run `pod spec lint UBARViewer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://developer.urbanbase.com/docs/lens/TUTORIAL.html"
  ...
  s.vendored_frameworks = 'ARViewer.framework'
