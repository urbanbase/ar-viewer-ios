...
SWIFT_PROTOCOL("_TtP8ARViewer10ARDelegate_")
@protocol ARDelegate
@optional
- (void)findPlane;
- (void)closeARViewer;
...
SWIFT_CLASS("_TtC8ARViewer8ARViewer")
...
@interface ARViewer (SWIFT_EXTENSION(ARViewer)) <ARDelegate>
- (void)closeARViewer;
- (void)selectProductWithSelectedFigure:(Figure * _Nullable)selectedFigure;
@end
...
SWIFT_CLASS("_TtC8ARViewer15ARViewerSCNView")
...
SWIFT_CLASS("_TtC8ARViewer6Figure")
@interface Figure : SCNReferenceNode
...
SWIFT_CLASS("_TtC8ARViewer21FigureInformationView")
@interface FigureInformationView : UIView
...
SWIFT_CLASS("_TtC8ARViewer18ThreeDimensionView")
@interface ThreeDimensionView : SCNView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame options:(NSDictionary<NSString *, id> * _Nullable)options SWIFT_UNAVAILABLE;
@end
...
@interface ThreeDimensionView (SWIFT_EXTENSION(ARViewer)) <SCNSceneRendererDelegate>
- (void)renderer:(id <SCNSceneRenderer> _Nonnull)renderer updateAtTime:(NSTimeInterval)time;
