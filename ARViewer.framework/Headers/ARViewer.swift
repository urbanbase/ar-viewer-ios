...
open class ARViewer: UIView {
    ...
    var mode: FeatureType = .AR {
        didSet {
            ...
            case .AR:
                ...
                resume(trackingMode: .horizontal)
    ...
    public var selectedFigure: Figure? {
        return figureInteraction.selectedFigure
    }
    
    public internal(set) var state: State = .Configure {
        willSet {
    ...
    @objc public var measurement = ARMeasurement()
    
    var shouldUpdateMeasurePoint: Bool = false
    var shouldRemoveMeasurePoint: Bool = false
    var onBoardingView: OnBoardingView?
    public var useOnBoardingView: Bool = false
    
    typealias SceneBlock = () -> ()
