...
#ifndef UBARVIEWER_SWIFT_H
#define UBARVIEWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UBARViewer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class MeasuredLine;

SWIFT_CLASS("_TtC10UBARViewer13ARMeasurement") SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface ARMeasurement : NSObject
@property (nonatomic, readonly, copy) NSArray<MeasuredLine *> * _Nonnull measuredLines;
@property (nonatomic, readonly, strong) MeasuredLine * _Nullable currentLine;
...
SWIFT_CLASS("_TtC10UBARViewer8ARViewer") SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface ARViewer : UIView
/// A view that enables you to display an AR experience.
/// It is subclass of <code>ARSCNView</code>.
@property (nonatomic, strong) ARViewerSCNView * _Nonnull arSceneView;
...
@property (nonatomic, readonly, strong) Figure * _Nullable selectedFigure;
...
@property (nonatomic, copy) NSString * _Nonnull contentsURL;
@property (nonatomic, readonly) BOOL isRRF;
@property (nonatomic, readonly) BOOL isShadowEnabled;
...
SWIFT_PROTOCOL("_TtP10UBARViewer16ARViewerDelegate_") SWIFT_AVAILABILITY(ios,introduced=11.3)
@protocol ARViewerDelegate
@optional
...
/// \param changed The detecting state being changed.
///
- (void)sessionWithState:(enum DetectingState)changed;
@end


SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface ARViewer (SWIFT_EXTENSION(UBARViewer)) <ARViewerDelegate>
- (void)closeARViewer;
- (void)selectProductWithSelectedFigure:(Figure * _Nullable)selectedFigure;
@end
...
SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface ARViewer (SWIFT_EXTENSION(UBARViewer)) <ARSCNViewDelegate, ARSessionDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface ARViewer (SWIFT_EXTENSION(UBARViewer))
...
/// Requests that the <code>Figure</code> to be loaded.
/// \param json jsonString of <code>UBAsset</code>.
///
- (void)requestFigureWithJson:(NSString * _Nonnull)json;
...
- (SCNVector3)getLightAngle SWIFT_WARN_UNUSED_RESULT;
- (void)setLightDirectionWithX:(CGFloat)x y:(CGFloat)y;
- (float)getShadowQuality SWIFT_WARN_UNUSED_RESULT;
...
/// Applies the <code>Realistic Reflection</code> feature to scene.
/// \param isEnabled A <code>Boolean</code> value that determines whether the rrf mode is enabled.
///
- (void)setRRFModeWithIsEnabled:(BOOL)isEnabled SWIFT_AVAILABILITY(ios,introduced=12.0);
...
SWIFT_CLASS("_TtC10UBARViewer15ARViewerSCNView") SWIFT_AVAILABILITY(ios,introduced=11.3)
...
typedef SWIFT_ENUM(NSInteger, DetectingState, open) {
/// The AR session has not gathered enough camera or motion data to provide tracking information.
  DetectingStateInitializing = 0,
/// Camera position tracking is not available.
  DetectingStateNotAvailable = 1,
/// The AR session is attempting to resume after an interruption.
  DetectingStateRelocalizing = 2,
/// The device is moving too fast for accurate image-based position tracking.
  DetectingStateExcessiveMotion = 3,
/// The scene visible to the camera doesn’t contain enough distinguishable features for image-based position tracking.
  DetectingStateInsufficientFeatures = 4,
/// The scene visible to the camera doesn’t contain enough distinguishable features for image-based position tracking.
  DetectingStateInsufficientFeaturesInWall = 5,
/// The scene visible to the camera doesn’t contain enough lighting conditions.
  DetectingStateInsufficientLight = 6,
/// The device is too far to tracking the surface.
  DetectingStateTooClose = 7,
/// The AR session is tracking the surface.
  DetectingStateTooFar = 8,
/// The device is too close to tracking the surface.
  DetectingStateNormal = 9,
};
...
SWIFT_CLASS("_TtC10UBARViewer6UBNode")
...
@class UBAsset;
enum FigureState : NSInteger;
@class UBStyle;

SWIFT_CLASS("_TtC10UBARViewer6Figure") SWIFT_AVAILABILITY(ios,introduced=11.3)
...
@property (nonatomic) float figureRotation;
/// fit to 20cm scale
@property (nonatomic) SCNVector3 fitScale;
@property (nonatomic) SCNVector3 scale;
@property (nonatomic, readonly) enum FigureState state;
@property (nonatomic, strong) UBStyle * _Nullable style;
@property (nonatomic) BOOL isSelected;
@property (nonatomic) BOOL zoomable;
@property (nonatomic) BOOL isSelectionHidden;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface Figure (SWIFT_EXTENSION(UBARViewer))
...
SWIFT_PROTOCOL("_TtP10UBARViewer24FigureAppearanceDelegate_") SWIFT_AVAILABILITY(ios,introduced=11.3)
...
SWIFT_PROTOCOL("_TtP10UBARViewer18FigureLoadDelegate_") SWIFT_AVAILABILITY(ios,introduced=11.3)
...
typedef SWIFT_ENUM(NSInteger, FigureState, open) {
  FigureStateLoaded = 0,
  FigureStatePreloaded = 1,
  FigureStatePlaced = 2,
};
...
/// <h2>Copyright</h2>
/// Copyright © 2018 Urbanbase Inc.
SWIFT_CLASS("_TtC10UBARViewer10FigureView") SWIFT_AVAILABILITY(ios,introduced=11.3)
...
@property (nonatomic) CGFloat backgroundIntensity;
@property (nonatomic, copy) NSString * _Nonnull contentsURL;
@property (nonatomic, weak) id <FigureViewDelegate> _Nullable delegate;
@property (nonatomic) BOOL isDimensionBoxEnabled;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
/// Requests that the <code>Figure</code> to be loaded.
...
SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface FigureView (SWIFT_EXTENSION(UBARViewer)) <SCNCameraControllerDelegate, SCNSceneRendererDelegate, UIGestureRecognizerDelegate>
- (void)renderer:(id <SCNSceneRenderer> _Nonnull)renderer updateAtTime:(NSTimeInterval)time;
- (void)cameraInertiaWillStartForController:(SCNCameraController * _Nonnull)cameraController;
- (void)cameraInertiaDidEndForController:(SCNCameraController * _Nonnull)cameraController;
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer * _Nonnull)otherGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface FigureView (SWIFT_EXTENSION(UBARViewer)) <FigureAppearanceDelegate, FigureLoadDelegate>
- (void)onDownloadProgressWithAssetId:(NSString * _Nonnull)assetId progress:(double)progress total:(double)total;
- (void)onDownloadWithAssetId:(NSString * _Nonnull)assetId;
- (void)onDownloadCompleteWithAssetIds:(NSArray<NSString *> * _Nonnull)assetIds requestCount:(NSInteger)requestCount successCount:(NSInteger)successCount failCount:(NSInteger)failCount;
- (void)onLoadingProgressWithAssetId:(NSString * _Nonnull)assetId progress:(double)progress total:(double)total;
...
SWIFT_PROTOCOL("_TtP10UBARViewer18FigureViewDelegate_")
@protocol FigureViewDelegate
@optional
- (void)dimensionBoxDidAppear;
- (void)dimensionBoxDidDisappear;
- (void)cameraInertiaWillStart;
- (void)cameraInertiaDidEnd;
@end


SWIFT_CLASS("_TtC10UBARViewer12MeasuredLine") SWIFT_AVAILABILITY(ios,introduced=11.3)
@interface MeasuredLine : UBNode
...
SWIFT_CLASS("_TtC10UBARViewer15PassthroughView")
...
typedef SWIFT_ENUM(NSInteger, RenderingMode, open) {
  RenderingModeFinalRender = 0,
  RenderingModeWireFrame = 1,
  RenderingModeCombine = 2,
};
...
typedef SWIFT_ENUM(NSInteger, TrackingMode, open) {
